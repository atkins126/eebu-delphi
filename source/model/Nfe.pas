...
uses
  ...
  Vcl.Dialogs, Vcl.FileCtrl, ACBrMail, ACBrValidador, ACBrDFeUtil, blcksock;
...
begin
  try
    ...
    begin
      ...
      Geral.SSLCryptLib:= TSSLCryptLib(3);
      Geral.SSLHttpLib:= TSSLHttpLib(3);
      Geral.SSLXmlSignLib:= TSSLXmlSignLib(2);
  ...
  try
    try
      ...
      begin
        ...
        Ide.cNF:= GerarCodigoDFe(StrToIntDef(Self.Cnf, 0));
