...
implementation
uses
  AuthService, Helper, Empresa, uformPrint, NfeConfiguracao;
{ TVenda }
...
//                           THelper.CPFMask(vVenda.Pessoa.Documento)));
          ...
          begin
            ...
            if vVenda.Itens.Items[I].Descricao <> '' then
              Print.Add('D|' + THelper.StrEsquerda('', 6) + ' ' + THelper.StrEsquerda(vVenda.Itens.Items[I].Descricao, 82))
          end;
