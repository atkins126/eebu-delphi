...
uses
  ...
  System.StrUtils, Datasnap.DBClient, Conta, Categoria, Pessoa, Vcl.Mask;
type
...
var
  situacao, boleto, filtro: Integer;
  dtStart, dtEnd: TDate;
  contaId, categoriaId, pessoaId: String;
begin
  filtro:= cbx_situacao.ItemIndex;
  boleto:= cbx_boleto.ItemIndex;
  situacao:= cbx_situacao.ItemIndex;
  dtStart:= dtp_start.Date;
  dtEnd:= dtp_end.Date;
