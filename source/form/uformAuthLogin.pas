...
uses
  ...
  Vcl.Imaging.pngimage, System.Generics.Collections, Vcl.Mask;
type
  TformAuthLogin = class(TformBase)
    ...
    procedure cbx_emailKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
  private
...
procedure TformAuthLogin.cbx_emailKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
    13: lbe_senha.SetFocus;
  end;
end;
